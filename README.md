...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/rattler-build-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/rattler-build-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
It is possible to list all of the versions of `rattler-build` available on your platform:
...
```
pixi search rattler-build --channel conda-forge
```
